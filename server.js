...
async function answerQuestion(question, images = [], history = [], userId = null) {
  ...
  const system =
    ...
    "Format the block EXACTLY like this — a bold '*📚 Sources:*' header, then one line per source " +
    "grouped by type, each hyperlinked as a Slack link <url|Descriptive Title>:\n" +
    "\n" +
    "*📚 Sources:*\n" +
    "Article: <https://…|Title>\n" +
