...
import { initStore, storeEnabled, storeFact, storeArticle, retrieveRelevant, retrieveBlended, retrieveSemantic, setEmbedding, storeFactWithEmbedding, fetchUnembedded, countEmbedded, getMeta, setMeta } from "./store.js";
...
async function ingestAllArticles() {
  ...
  try {
    ...
    while (run < MAX_PAGES_PER_RUN && nextUrl) {
      ...
      if (!nextUrl) {
        if (processed > 0 || (await getMeta("articles_seen_any")) === "1") {
