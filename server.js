...
async function answerQuestion(question, images = [], history = []) {
  ...
  const system =
    ...
    "section's instructions). If the retrieved knowledge doesn't cover the question, say you don't " +
    "have that documented yet and suggest where they might look — do not invent features or steps. " +
    "Be concise and practical. When greeting someone or asked what you can do, say you can help with " +
    "nova, omega, and signal questions.\n\n" +
